...
Diagnostics.ERROR_CODES =
{
    ...
    PLAYER_SANDBOX_TEST_CONTEXT_REQUIRED = "PLAYER_SANDBOX_TEST_CONTEXT_REQUIRED",
    PLAYER_SANDBOX_TEST_ACTION_INVALID = "PLAYER_SANDBOX_TEST_ACTION_INVALID",
    SKILLTREE_HANDSHAKE_INVALID = "SKILLTREE_HANDSHAKE_INVALID",
...
Diagnostics.RESULTS =
{
    ...
    ZONE_LIST = "ZONE_LIST",
    PLAYER_TEST_ENABLED = "PLAYER_TEST_ENABLED",
    PLAYER_TEST_DISABLED = "PLAYER_TEST_DISABLED",
    PLAYER_TEST_STATUS = "PLAYER_TEST_STATUS",
    SKILLTREE_HANDSHAKE_COMPLETE = "SKILLTREE_HANDSHAKE_COMPLETE",
}
